    ...
    <StudentDashboardLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="relative overflow-hidden mb-8">
          ...
          <Card className="relative mx-6 border-0 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white shadow-xl overflow-hidden">
          ...
          <CardContent className="p-8">
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-600">Search through thousands of opportunities</p>
              </div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-4">
                    <div className="relative flex-1">
                      ...
                      <Input
                        ...
                        className="pl-12 h-14 text-lg border-gray-200 bg-gray-50/50 focus:bg-white transition-all duration-300"
                        value={searchTerm}
                    ...
                    <Button 
                      ...
                      className="h-14 px-8 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                      disabled={showRecommended}
                    >
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Personalized matches</p>
                      </div>
                    </div>
                    <Switch 
                ...
                {loading ? (
                  ...
                  <Card className="border-0 shadow-lg bg-white text-center">
                    <CardContent className="py-16">
                      ...
                      <Button 
                        onClick={loadJobs} 
                        className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-3 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                      >
                        Try Again
                      </Button>
                    </CardContent>
                  ...
                  <>
                    {jobs.length === 0 ? (
                      <Card className="border-0 shadow-lg bg-white text-center">
                        <CardContent className="py-16">
                          <div className="mx-auto w-24 h-24 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center mb-8">
                      ...
                      <div className="space-y-6">
                        {jobs.map((job, index) => (
                          <Card key={job.id} className="group border-0 shadow-lg hover:shadow-xl transition-all duration-500 bg-white/95 backdrop-blur-sm overflow-hidden transform hover:-translate-y-1">
                            {/* Accent bar */}
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {job.tags.slice(0, 6).map((tag, tagIndex) => (
                                    <Badge 
                                      key={tagIndex} 
                                      variant="outline"
                                      className="bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 border-blue-200 hover:bg-blue-100 transition-colors"
                                    >
                                      {tag}
                                    </Badge>
                                  ))}
