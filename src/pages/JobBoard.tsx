      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-blue-100">
            Browse through thousands of jobs and apply with your resume
          </p>
        </div>
        ...
        <Card className="shadow-lg border-0">
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 bg-white rounded-xl shadow-lg p-3 flex flex-col md:flex-row gap-2">
              ...
              {loading ? (
                ...
                <Card className="border-0 shadow-lg p-6 text-center bg-white">
                  <div className="py-12">
                    ...
                    <h2 className="font-medium text-2xl mb-3">Error Loading Jobs</h2>
                  ...
                  {jobs.length === 0 ? (
                    <Card className="border-0 shadow-lg p-6 text-center bg-white">
                      <div className="py-12">
                        ...
                        <h2 className="font-medium text-2xl mb-3">No jobs found</h2>
                    ...
                    <div className="space-y-4">
                      {jobs.map((job) => (
                        <Card key={job.id} className="border-0 shadow-md hover:shadow-lg transition-shadow overflow-hidden">
                          ...
                          <CardHeader className="pb-2 pt-5">
                            <div className="flex items-start justify-between">
                              <div>
                                ...
                                <div className="flex flex-wrap text-gray-600 text-sm gap-3 mt-1">
                                  <div className="flex items-center">
                                    <Building className="h-3.5 w-3.5 mr-1 text-blue-500" />
                                    {job.company}
                                  </div>
                                  <div className="flex items-center">
                          ...
                          <CardContent>
                            <p className="text-sm line-clamp-3 text-gray-700">{job.description}</p>
                          ...
                          <CardFooter className="flex justify-between pt-0 pb-5">
                            ...
                            >
                              <Button 
                                size="sm" 
                                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white gap-1 rounded-full"
                              >
                                Apply Now
                  ...
                  {!showRecommended && jobs.length > 0 && (
                    <div className="flex justify-between items-center mt-8">
                      <Button 
                        ...
                        className="flex items-center gap-1 border border-blue-200 hover:bg-blue-50"
                      >
                        <ChevronLeft className="h-4 w-4" /> 
                        Previous
                      </Button>
                      <span className="flex items-center text-sm bg-blue-100 text-blue-800 px-4 py-2 rounded-full">
                        Page {currentPage}
                      </span>
                      <Button 
                        variant="outline" 
